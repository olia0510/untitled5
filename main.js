...
//
    ...
    document.write('<div class="usersList-box">');
for (const user of usersList) {
    document.write(
        `<div class="usersList-block">
            ...
            <div class="geo-block">
                <p>${user.geo} - ${user.address.geo.lat}</p>
                <p>${user.geo} - ${user.address.geo.lng}</p>
            </div>
            <div class="company-block">
                <p>${user.name} - ${user.company.name}</p>
                <p>${user.catchPhrase} - ${user.company.catchPhrase}</p>
                <p>${user.bs} - ${user.company.bs}</p>
            </div>
